...
/*
	RELEASE NOTES v 3-4-2

	removed cout lines to destructors constructors and assignment operators used to quantify improvement from using colon syntax. 

	Added base class Shape to hiearchy and appropriate calls to the inherited m_id. 
*/
...
std::string Point::ToString() const{
	return ("Point ID: " + std::to_string(m_id) + "( " + std::to_string(x) + ", " + std::to_string(y) + " )\n");
}
