...
/*
	...
	amended constructors with colon syntax. 
...
*/
Circle::Circle() : m_radius(5), center(){
}
...
*/
Circle::Circle(Point center_, double rad_) : center(center_), m_radius(rad_) {
}
...
copy constructor
*/
Circle::Circle(const Circle& source) : m_radius(source.m_radius), center(source.center){
}
