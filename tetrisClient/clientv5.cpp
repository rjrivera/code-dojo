...
//	Note - 30 Jan - attempted all initial AI's to remedy input capture related segfault and can't resolve. ignoring, as it's not important// current TODO[ ] create a simple multiplayer incentive to move faster than your opponent.
//		- creating a container of other active pieces for each just one player 
//	next TODO[ ] create a multiplayer communication pipeline.  
////
